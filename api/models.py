...
class SubCategory(models.Model):
    ...
    fuel_info = models.CharField(verbose_name='информация о топливе', max_length=255)
...
class Products(models.Model):
    ...
    fuel = models.CharField(verbose_name='топливо', max_length=255)
    gearbox = models.CharField(verbose_name='коробка', max_length=255)
    car_body = models.CharField(verbose_name='кузов', max_length=255)
    drive = models.CharField(verbose_name='привод', max_length=255)
    volume = models.CharField(verbose_name='объем', max_length=255)
